	...
	※ 「PC통신 등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」...
		...
		<form action="../join/join_detail_en.do" method="post"
			...
			<div class="mail_check_input_box" id="mail check input box false">
				<input class="mail_check_input" disabled="disabled" type="text" placeholder="인증번호" required>
			</div>
			...
			<div class="nameBirthD">
				<input type="text" placeholder="이름" name="en_name" required>
				<input type="text" name="en_no" placeholder="사업자 번호" required>
				<div class="birth">
					<span>생년월일</span><input type="date" class="email_join" value="1990-01-01" name="en_birth" required>
				</div>
			</div> 
