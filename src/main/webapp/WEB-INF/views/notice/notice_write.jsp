...
<div class="container inquiry_wrap">
	<div class="inner">
		<form name="inquiry_write" action="/notice/submit.do" method="post" action="submit" class="inquiry_form">
			<div class="revWrite">
				<div class="left">
					<h3>공지사항 등록</h3>
					<p>내용을 입력해 주세요.</p>
				...
				<div class="right">
					<div class="formCont">
						...
						<dt>내용</dt>
						<dd>
							<textarea name="n_contents" id="n_contents" placeholder="공지사항 내용을 입력해주세요" required=""></textarea>
						</dd>
					</dl>
					</div>
				</div><!-- //right  -->
	...
	<!-- <form name="inquiry_write" action="/notice/submit.do" method="post"
		action="submit" class="inquiry_form">
