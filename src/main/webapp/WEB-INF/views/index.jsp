...
<meta
	content="width=device-width,user-scalable=no,maximum-scale=1.0,minimum-scale=1.0,target-densitydpi=medium-dpi,initial-scale=1.0"
	name="viewport" />
<link rel="stylesheet"
		...
		<nav class="nav">
			<div class="container">
				<div id="mainListDiv" class="main_list">
					<ul class="navlinks">
						<li class="logo"><a href="/home.do"><span>SSOL.
									STUDYCAFE</span></a></li>
				...
				<div class="logo mlogo">
					<a href="#">SSOL. STUDYCAFE</a>
				</div>
				<a href="javascript:" class="navTrigger"> <i></i> <i></i> <i></i>
				</a>
			</div>
		</nav>
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide vs1">
							<div class="txtD">
								...
								<p class="txt">
									스터디 회의실 제공 <br>최적의 장소에서 업무 효율 극대화!
								</p>
							</div>
						</div>
						<div class="swiper-slide vs2">
							<div class="txtD">
								<p class="tit">SSOL STUDYCAFE</p>
								<p class="txt">
									여유있는 좌석 <br>같은 시간을 공부해도 더 효과적인 공간
								</p>
							</div>
						</div>
						<div class="swiper-slide vs3">
							<div class="txtD">
								<p class="tit">SSOL STUDYCAFE</p>
								<p class="txt">
									오직 공부만을 위해 만들어진 <br>프리미엄 스터디 공간!
								</p>
							</div>
						</div>
						<div class="swiper-slide vs4">
							<div class="txtD">
								<p class="tit">SSOL STUDYCAFE</p>
								<p class="txt">
									고객을 위한 편의시설 <br>고급 커피, 음료, 공용PC, 프린터가 모두 무료제공됩니다.
								</p>
							</div>
						</div>
					</div>
